...
var autocomplete = function autocomplete(input, latInput, lngInput) {
  ...
  input.on('keydown', function (e) {
    if (e.keyCode === _keyCodes2.default.ENTER) e.preventDefault();
  });
};
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 50.4310737;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 30.5093819;

  _axios2.default.get((0, _constants.API_STORES_NEAR_WITH_QUERY_URL)([lat, lng])).then(function (res) {
    var places = res.data;
    ...
    markers.forEach(function (marker) {
      return marker.addListener('click', function () {
        ...
        var imageSrc = photo || 'store.png';
        var html = '\n          <div class="popup">\n            <a href=' + (0, _constants.STORE_URL)(slug) + '>\n                <img src=' + (0, _constants.UPLOADS_RESOURCES_URL)(imageSrc) + ' alt=' + name + ' />\n                \n                <p>' + name + ' - ' + location.address + '</p>\n            </a>\n          </div>\n        ';
...
function makeMap(mapDiv, coordinates) {
  ...
  var map = new google.maps.Map(mapDiv, mapsOption);
...
var searchResultsHTML = function searchResultsHTML(stores) {
  return stores.map(function (store) {
    return '\n    <a href="' + (0, _constants.STORE_URL)(store.slug) + '" class="search__result">\n        <strong>' + store.name + '</strong>\n    </a>\n';
  }).join('');
};
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get((0, _constants.API_SEARCH_WITH_QUERY_URL)(this.value)).then(function (res) {
      if (res.data.length) {
  ...
  searchInput.on('keyup', function (e) {
    ...
    switch (e.keyCode) {
      ...
      case current && _keyCodes2.default.ENTER:
...
exports.urlWithDelimiter = function (url, args) {
  var delimiter = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : /(\$\{\w+\})/gi;

  args = Array.isArray(args) || typeof args === 'undefined' ? args : [args];

  var variableReg = new RegExp(delimiter);
  var matchLength = url.match(variableReg) ? url.match(variableReg).length : 0;
  ...
  var urlArray = url.split(variableReg);

  urlArray.forEach(function (item) {
    newUrl.push(!item.match(variableReg) ? item : args[argumentsIndex++]);
  });
...
var _favoriteStores = __webpack_require__(13);

var _favoriteStores2 = _interopRequireDefault(_favoriteStores);
...
if (map) {
  ...
  var success = function success(pos) {
    (0, _map2.default)(map, pos.coords);
  };
...
(0, _bling.$$)('form.heart').on('submit', _favoriteStores2.default);
